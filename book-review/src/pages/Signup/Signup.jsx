        ...
        <div className='bg-white-800 flex flex-col justify-center'>
            <form className='max-w-[400px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8'>
                ...
                <div className='flex flex-col text-gray-400 py-2'>
                    ...
                    value={username}  onChange={(e)=> setUsername(e.target.value)} placeholder="Username" autoComplete='off'
 />
                </div>
                <div className='flex flex-col text-gray-400 py-2'>
                ...
                <button onClick={(e) => handlesubmit(e)} className='w-full my-5 py-2 bg-purple-500 shadow-lg shadow-purple-500/50 hover:shadow-purple-500/40 text-white font-semibold rounded-lg' type='submit'>SIGN UP</button>
